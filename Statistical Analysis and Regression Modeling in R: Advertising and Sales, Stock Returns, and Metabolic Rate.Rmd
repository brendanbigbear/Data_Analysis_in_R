---
title: "Sungwook Park Homework 4"
...
2. Use the d logret 6stock data set to answer the questions.
...
3. With the rmr data set (ISwR package), plot metabolic rate versus body weight. Fit a linear regression model to the relation. According to the fitted model, what is the predicted metabolic rate for a body weight of 80kg?
```{r}
